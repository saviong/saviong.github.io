...
>(({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
        <DropdownMenuPrimitive.Content
            ...
            className={cn(
                "z-[1000] min-w-[200px] max-h-[400px] overflow-hidden rounded-lg border bg-white dark:bg-gray-900 p-2 text-foreground shadow-xl",
...
>(({ className, inset, ...props }, ref) => (
    <DropdownMenuPrimitive.Item
        ...
        className={cn(
            ...
            "focus:bg-gray-100 dark:focus:bg-gray-800 focus:text-foreground",
